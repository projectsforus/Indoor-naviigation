        ...
        if (shouldSaveMap)
        {
            ...
            LibPlacenote.Instance.SaveMap(
                ...
                (completed, faulted, percentage) =>
                {
                    ...
                    {
                        debugText.text="Upload of Map Named: " + mCurrMapDetails.name + "faulted";
                    }
                    else
                    {
                        debugText.text="Uploading Map Named: " + mCurrMapDetails.name + "(" + percentage.ToString("F2") + "/1.0)";
                    }
                }
            );
        }
